...
//
//
namespace SluaDevMenu {
//
	public class SluaDevMenu {
//
...
//
//
		[MenuItem("SLuaDev/3.SetupSublimeText3(请先打开Sublime再进行设置)")]
		public static void MoveToLuaDevToSublime3Package()
		{
			string srcDirPath = Application.dataPath + "/SluaDev";
			#if UNITY_EDITOR_OSX 
			// 以下的admin要改成自己的计算机名称
			// 1：Users 2:username
			string dstDirPath = "/Users/"+ Environment.UserName  + "/Library/Application Support/Sublime Text 3/Packages/SluaDev";
			#else
			// 以下的admin要改成自己的计算机名称
			// 1：Users 2:username
			string dstDirPath = "C:\\Users\\"+ Environment.UserName  + "\\AppData\\Roaming\\Sublime Text 3\\Packages\\SluaDev";
			#endif
...
//			// 以下的admin要改成自己的计算机名称
//			// 1：Users 2:username
//			string dstDirPath = "/Users/"+ Environment.UserName + "/Library/Application Support/Sublime Text 2/Packages/SluaDev";
//			#else
//			// 以下的admin要改成自己的计算机名称
//			// 1：Users 2:username
//			string dstDirPath = "C:\\Users\\"+ Environment.UserName  + "\\AppData\\Roaming\\Sublime Text 2\\Packages\\SluaDev";
//			#endif
//
//			CopyDir (srcDirPath, dstDirPath);
//		}
