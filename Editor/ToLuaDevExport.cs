...
//	}
//
//	static void GeneratePropertyComplete(string propertyName,bool isStatic = false)
//	{
//
//
...
//		if (plits.Length == 2) {
//			if (isStatic) {
//				sb.AppendFormat ("\t\t\"{0}.{1}\",\n", plits [1], propertyName);
//			}
//			else {
//				sb.AppendFormat ("\t\t\"{0}.{1}\",\n", plits [1].Substring (0, 1).ToLower () + plits [1].Substring (1), propertyName);
//			}
//		} else if (plits.Length == 1) {
//			if (isStatic) {
//				sb.AppendFormat ("\t\t\"{0}.{1}\",\n", plits [0], propertyName);
//			}
//			else {
//				sb.AppendFormat ("\t\t\"{0}.{1}\",\n", plits [0].Substring (0, 1).ToLower () + plits [0].Substring (1), propertyName);
//			}
//		}
//
//	}
...
//		}
//
//		Debugger.Log("Begin Generate lua completions file for class {0}", className);        
//		sb = new StringBuilder();
//
//		if (wrapClassName == "")
//		{
...
//	{        
//		using (StreamWriter textWriter = new StreamWriter(file,false,new System.Text.UTF8Encoding(false)))
//		{            
...
//		{
//			GeneratePropertyComplete (fields [i].Name, fields [i].IsStatic);
//		}
//
//		for (int i = 0; i < props.Length; i++)
//		{
//			GeneratePropertyComplete (props [i].Name, isStaticClass);
//		}
//
//		for (int i = 0; i < events.Length; i++)
//		{
//			GeneratePropertyComplete (events [i].Name,isStaticClass);
//		}  
//	}   
//
...
//			GeneratePropertyComplete (funcName, true);
//		}
//
//		for (int i = 0; i < list.Count; i++)
//		{
...
//			args.Add (paramInfos [i].ParameterType.ToString () + ":" + paramInfos [i].Name);
//		}
//
//		GenerateFunctionComplete (GetMethodName(m), args.ToArray(), m.IsStatic);
//	}
//
...
//	{
//
//		GenerateFunctionComplete ("New", null, true);
//	}
//
...
//				GenerateFunctionComplete (strfun, null,true);
//				return;
//			}
//		}
//
...
//			{
//				MethodBase md = ctorList[i];
//				ParameterInfo[] paramInfos = md.GetParameters();
//				List<string> args = new List<string> ();
//				for (int j = 0; j < paramInfos.Length; j++) {
//					args.Add (paramInfos [j] .ParameterType.ToString () + ":" + paramInfos [j].Name);
//				}
//
//				GenerateFunctionComplete ("New", args.ToArray(),true);	
//			} 
//		}
//			
//
...
//		}
//
//		GenerateFunctionComplete ("New", args.ToArray(),md.IsStatic);
//	}
//
